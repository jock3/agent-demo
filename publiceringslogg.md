# Publiceringslogg — Sundets Rosteri

Vad som faktiskt gått ut. Uppdateras vid varje leverans, innan ärendet stängs.
Utan den går varken kadensen eller fördelningen i `plattformar.md` att
kontrollera.

`Kategori` är fördelningen 70/20/10 i `plattformar.md`: **värde** (värde och
process), **varumärke**, **sälj** (direkt sälj).

| Datum | Plattform | Format | Kategori | Ärende | Utfall |
|---|---|---|---|---|---|
| 2026-03-12 | Instagram | karusell, 5 bilder | värde | Rostprotokoll, kasserad lott | 4,8% ER, 61 sparningar |
| 2026-04-08 | LinkedIn | text-post | sälj | Driftstopp och servicelöfte | 2,9% ER, 7 förfrågningar |
...
- En rad per publicerad post, nyast sist.
- Fyll i `Utfall` när siffrorna finns, inte vid publicering. Lämna tomt tills
  dess — gissa aldrig.
- Kontrollera fördelningen mot målet innan nästa ärende föreslås, inte efteråt.
- Ligger en kategori efter: säg det i förslaget till Gustav i stället för att
  tyst kompensera.
