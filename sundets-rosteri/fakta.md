...
| Produkt | Storlek | Pris |
|---|---|---|
| Ängö Ljus, filterrost | 250 g | 129 kr |
| Ängö Ljus, filterrost | 1 kg | 439 kr |
| Sundet Mörk, espressorost | 250 g | 129 kr |
| Kontorsabonnemang, från | per månad | 890 kr |
| Bryggkurs i kafét | 2 timmar | 495 kr |

## Certifieringar

- **Ängö Ljus** är KRAV-märkt. Får kallas ekologisk.
- **Sundet Mörk** är INTE certifierad. Får aldrig kallas ekologisk eller KRAV.
- Ingen Fairtrade-certifiering på något led. Får aldrig påstås.

## Godkända påståenden

- "Rostat i Kalmar"
- "Rostat 3–5 dagar före leverans" (endast B2B)
- "Direktimport från två gårdar i Honduras" (gäller Ängö Ljus)
- "KRAV-märkt" (endast Ängö Ljus)

## Förbjudna påståenden

- Allt om hälsoeffekter av kaffe
- "Sveriges bästa" eller liknande superlativ utan mätbar grund
